...
export class Backend implements backendInterface {
    ...
    async checkout(arg0: CustomerInfo): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
